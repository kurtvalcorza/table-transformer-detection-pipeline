...
|---|---|---|---|---|
| `table_transformer_detection_colab.ipynb` (`E2E`) | `35d1465` / `250740ff` | 2026-09-19 | Kaggle Tesla T4 (`kurtvalcorza/dimer-nb2-table-transformer-detection` v3; image `torch 2.10.0+cu128` / `transformers 5.0.0` before the pinned install, `torch 2.14.0+cu130` / `transformers 4.57.6` after, Python 3.12.13, `cuda:0`) | **PASSED** — 11/11 code cells ok (1 restart after install cell); 131 files, 245 MB staged from the Hub into a clean cache; comparison {ap50: {fixed_box_prior: 0.0266, zero_shot: 0.0967, frozen_policy: 0.3179, selected_policy: 0.3315}, ap75: {fixed_box_prior: 0, zero_shot: 0.0017, frozen_policy: 0.0681, selected_policy: 0.0659}, map: {fixed_box_prior: 0.0054, zero_shot: 0.029, frozen_policy: 0.1438, selected_policy: 0.1288}, mean_best_iou: {fixed_box_prior: 0.3155, zero_shot: 0.4887, frozen_policy: 0.5968, selected_policy: 0.6036}, recall_at_0.5: {fixed_box_prior: 0.1154, zero_shot: 0.0385, frozen_policy: 0.6923, selected_policy: 0.6538}, precision_at_0.5: {fixed_box_prior: 0.12, zero_shot: 0.2, frozen_policy: 0.1406, selected_policy: 0.1241}, recall_at_0.9: {fixed_box_prior: 0.1154, zero_shot: 0.0385, frozen_policy: 0, selected_policy: 0}, loss: {frozen_policy: 2.52, selected_policy: 2.517}, delta_vs_frozen: {ap50: 0.0136, ap75: -0.0022, map: -0.0149}, delta_vs_zero_shot: {ap50: 0.2348, ap75: 0.0642, map: 0.0998}, selected_policy: unfrozen last 2 decoder layers + new heads}; reload parity {queries_identical: True, ap50_in_memory: 0.3315, ap50_reloaded: 0.3315, classes_identical: True}; run summary and executed notebook archived under `.agent/backups/kaggle-e2e-2026-09-19/out/dimer-nb2-table-transformer-detection/v3/evidence/` in the workspace |
...
|---|---|---|---|---|---|
| 2026-09-19 | `35d1465` / `250740ff` | Kaggle Tesla T4 (`kurtvalcorza/dimer-nb2-table-transformer-detection` v3; image `torch 2.10.0+cu128` / `transformers 5.0.0` before the pinned install, `torch 2.14.0+cu130` / `transformers 4.57.6` after, Python 3.12.13, `cuda:0`) | Default sample path, `Run all` from a fresh interpreter with an empty Hugging Face cache and no repository checkout (blob SHA-1 verified against GitHub before execution) | 1078.1 s | **PASSED** — 11/11 code cells ok (1 restart after install cell); 131 files, 245 MB staged from the Hub into a clean cache; comparison {ap50: {fixed_box_prior: 0.0266, zero_shot: 0.0967, frozen_policy: 0.3179, selected_policy: 0.3315}, ap75: {fixed_box_prior: 0, zero_shot: 0.0017, frozen_policy: 0.0681, selected_policy: 0.0659}, map: {fixed_box_prior: 0.0054, zero_shot: 0.029, frozen_policy: 0.1438, selected_policy: 0.1288}, mean_best_iou: {fixed_box_prior: 0.3155, zero_shot: 0.4887, frozen_policy: 0.5968, selected_policy: 0.6036}, recall_at_0.5: {fixed_box_prior: 0.1154, zero_shot: 0.0385, frozen_policy: 0.6923, selected_policy: 0.6538}, precision_at_0.5: {fixed_box_prior: 0.12, zero_shot: 0.2, frozen_policy: 0.1406, selected_policy: 0.1241}, recall_at_0.9: {fixed_box_prior: 0.1154, zero_shot: 0.0385, frozen_policy: 0, selected_policy: 0}, loss: {frozen_policy: 2.52, selected_policy: 2.517}, delta_vs_frozen: {ap50: 0.0136, ap75: -0.0022, map: -0.0149}, delta_vs_zero_shot: {ap50: 0.2348, ap75: 0.0642, map: 0.0998}, selected_policy: unfrozen last 2 decoder layers + new heads}; reload parity {queries_identical: True, ap50_in_memory: 0.3315, ap50_reloaded: 0.3315, classes_identical: True}; run summary and executed notebook archived under `.agent/backups/kaggle-e2e-2026-09-19/out/dimer-nb2-table-transformer-detection/v3/evidence/` in the workspace |
