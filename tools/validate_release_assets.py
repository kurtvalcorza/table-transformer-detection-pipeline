"""Static release-asset validation for the Table Transformer detection DIMER pipeline.
...
EXPECTED_OUTPUTS = (
    ...
    "outputs/table_transformer_detection_detections.csv",
    "outputs/table_transformer_detection_annotated.png",
)
...
CODE_MARKERS = (
    ...
    "((70, 330, 780, 660, 8, 5, 'Region'), (70, 760, 430, 990, 5, 3, 'Item'))",
...
MARKDOWN_MARKERS = (
    ...
    "**softmax class probability under the model's own head, not a calibrated",
    "**ordered by descending score**",
    "mean average precision needs a labelled page set",
